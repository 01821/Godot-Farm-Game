class_name PlantItems extends VBoxContainer

const PLANT_ITEM_SCENE = preload("res://scene/UI/plant_item.tscn")
var plants_res_path:String = "res://scene/plant/res/"
var plants_res_array:Array[PlantRes]

func _ready() -> void:
	dir_contents(plants_res_path)
'''遍历植物资源目录，加载商店UI'''
func dir_contents(path):
	...
	plants_res_array.sort_custom(sort_by_min_price)
...
'''价格从小到大排序'''
func sort_by_min_price(a:PlantRes,b:PlantRes):
	return a.price < b.price
'''价格从大到小排序'''
func sort_by_max_price(a:PlantRes,b:PlantRes):
	return a.price > b.price
'''成熟时间从小到大排序'''
func sort_by_time(a:PlantRes,b:PlantRes):
	return a.timeBtwStages > b.timeBtwStages
